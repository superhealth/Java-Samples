...
import com.sh.chapter3.bean.SingletonBeanRegister;
import com.sh.chapter3.bean.SingletonClassLoader;
...
public class SingletonTest {
	...
	public void testSingleton() throws Exception {
		...
		// 2.加载需要的类
		Class clazz = classLoader.loadClass("com.sh.chapter3.bean.Singleton");
		// 3.通过反射获取单例对象
		...
		// 2.加载需要的类
		Class clazz2 = classLoader2.loadClass("com.sh.chapter3.bean.Singleton");
		// 3.通过反射获取单例对象
